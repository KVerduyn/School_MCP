...
interface CalendarEntry {
  ...
  flanders: boolean;
  wallonia: boolean;
  northNetherlands: boolean;
  middleNetherlands: boolean;
  southNetherlands: boolean;
  luxembourg: boolean;
  holidayBelgium: boolean;
  holidayNetherlands: boolean;
  holidayLuxembourg: boolean;
}

export class CalendarData {
  private data: CalendarEntry[] = [];
  ...
  getVacationPeriods(region: string, year?: number): Array<{start: string, end: string}> {
